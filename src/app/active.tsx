...
export default function ActiveAlertScreen() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => void Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Heavy), 350);
    ...
    <View style={styles.screen}>
      ...
      {askCancel && (
        <Pressable
          ...
          onPress={() => setAskCancel(false)}
        >
          <Pressable style={styles.sheet} onPress={() => {}}>
            <Text style={styles.sheetTitle}>¿Cancelar la alerta?</Text>
            <Text style={styles.sheetBody}>
              Tus contactos recibirán una notificación de que estás a salvo.
              Solo cancela si realmente estás fuera de peligro.
            </Text>
